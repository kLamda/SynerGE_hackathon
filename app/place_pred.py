...
def predict_place(num):
  seq_length=7
  dat=pd.read_csv(staticfiles_storage.path('csv/test_state.csv'))
  input_size = 5
  hidden_size = 10
  num_layers = 1
  ...
  wgt=staticfiles_storage.path('place_weights/place_trend.th')
 
  model1,optimizer1=load_model(wgt,model,optimizer)
  model=model.eval()
